...
from .views import home, article_list, federal_wanted_list, delete_federal_wanted,local_criminals_list, add_local_criminal, add_panishment, archive_panishment
